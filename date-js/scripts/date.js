var DateJSLanguage = window.navigator.userLanguage || window.navigator.language;
if (DateJSLanguage.toLowerCase() == "en-us" || DateJSLanguage.toLowerCase() == "en")
{
	/**
	 * Version: 1.0 Alpha-1 
...
if (Date.CultureInfo)
{
	Date.CultureInfo.regexPatterns = {
		...
		ordinalSuffix: /^\s*(st|nd|rd|th)( of)?/i,
		timeContext: /^\s*(\:|a|p)/i
	};

	Date.CultureInfo.abbreviatedTimeZoneStandard = { GMT: "-000", EST: "-0400", CST: "-0500", MST: "-0600", PST: "-0700" };
	Date.CultureInfo.abbreviatedTimeZoneDST = { GMT: "-000", EDT: "-0500", CDT: "-0600", MDT: "-0700", PDT: "-0800" };
}
